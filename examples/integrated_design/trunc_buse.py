...
design_vals = {
    'M1': 8.234,               # Mach number at station 2
    'p3_p1': 50E3 / 2.266e+03, # angle of terminating shock [rad]
...
scale_factor = 1.3
field.Streamline = field.Streamline.scale(scale_factor, scale_factor, scale_factor)
